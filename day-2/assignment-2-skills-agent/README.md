...
1. **Context engineering.** With 50 skills your system prompt would be huge,
   and the model would pay attention to none of it (that is "context rot",
   which you saw in the fundamentals). With skills, the agent loads only what it
...
and tell me which of your machines fits"*, so browse and tools are combined.

## 🚀 Stretch goals

- **Write your own skill.** Pick something fun, like `writing-haiku-reviews.md`,
...
- What made the agent actually *use* the skills? Which wording in your
