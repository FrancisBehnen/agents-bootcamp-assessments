---
name: writing-product-advice
description: How to write a great product advice answer, step by step
---

# Skill: Writing product advice

Use this skill whenever a customer asks for advice about which product to
buy, or whether a product suits their needs.

## Steps

1. **Understand the situation first.** Identify what the customer will use
...
5. **Close with a decision helper.** One sentence: "Go for X if ..., go for
   Y if ...".
