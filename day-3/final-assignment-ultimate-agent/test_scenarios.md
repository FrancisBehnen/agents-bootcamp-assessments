...
Test your system against ALL of these before the demo — the jury will run a
selection live. They go from friendly to downright hostile.
...
9. "What's the status of order ORD-9999?" *(doesn't exist — honest failure,
   no hallucinated order)*
