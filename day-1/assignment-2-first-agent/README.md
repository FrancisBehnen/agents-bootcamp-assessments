...
already wired in — you don't touch any of that. Just fill in **`SYSTEM_PROMPT`**
...
memory"* and re-run. Does the math go wrong? That's *why* agents use tools.
...
are the single biggest lever on tool use — this is the whole lesson.
